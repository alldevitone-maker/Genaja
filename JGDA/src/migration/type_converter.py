...
class TypeConverter:
    """
    Serviço de Conversão e Normalização de Tipos.
...
_vdeclare(__name__, "0.7.1", "Normalizador de tipos interoperável com suporte a locales BR/EN e sanitização IEEE 754")
