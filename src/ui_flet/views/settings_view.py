...
class SettingsView(ft.Column):
    """
    View de Ajustes do Sistema (v0.6.0).
                ...
                ft.Container(
                    **PlatinumTheme.card_style(),
                    ...
                    content=ft.Column([
                        ...
                        ft.Text("Versão: v0.6.0 Alpha", color=PlatinumTheme.TEXT_SECONDARY()),
                        ft.Text("Modo: Platinum 2026", color=PlatinumTheme.TEXT_SECONDARY()),
