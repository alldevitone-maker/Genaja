...
class CompatibilityDialog(ft.AlertDialog):
    """
    Diálogo de Compatibilidade Assistida (v0.6.3 Patch 3).
    Apresenta justificativa para sugestões de mapeamento.
    """
    def __init__(self, src_col, tgt_col, score, reason, on_apply):
        self.on_apply = on_apply
        
        super().__init__(
            title=ft.Text("Assistente de Mapeamento 🤖", weight=ft.FontWeight.BOLD),
            content=ft.Column([
