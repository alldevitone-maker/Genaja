...
class ETLService:
    def __init__(self, mapping_engine=None, validation_engine=None):
        self.mapping_engine = mapping_engine
        self.validation_engine = validation_engine

    def execute_sync(self, df_src, df_tgt, mapping, key_src, key_tgt, key_tgt_final, clean_output=True):
    ...
    def execute_comparison(self, df_src, df_tgt, key_src, key_tgt, comp_tipo, clean_output, mapping, key_tgt_final):
        """Core Engine: Comparação de lacunas entre bases."""
